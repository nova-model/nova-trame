...
You can install trame-facade directly with
...
To create your application, you'll first need to setup an application class that inherits from :code:`trame.facade.TrameApp`. This class will provide a default layout and theme for your application.
